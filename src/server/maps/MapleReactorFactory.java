	...
	public static final MapleReactorStats getReactor(int rid) {
		...
		if (stats == null) {
			...
			if (stats == null) {
				...
				/*
				 * int i = 0; switch(rid) { case 2002011: case 2002012: case 2002013: case 2618003: case 2618004: case 2618005: case 2618006: case 2618007: case 2002018: case 9101000: case 2512001: case 6109016: case 6109017: case 6109018: case 6109019: case 6109020: i = 1; break; case 2006000: i = 20; break; } for (int x = 0; x < i; x++) { stats.addState((byte) x, 0, null, (byte) (x+1), 0); //test }
				 */
