...
public class PlayerInteractionHandler {
	...
	public enum Interaction {
		...
		CREATE(6), INVITE_TRADE(11), DENY_TRADE(12), VISIT(9), HIRED_MERCHANT_MAINTENANCE(21), CHAT(14), EXIT(18), OPEN(16), SET_ITEMS(0), SET_MESO(1), CONFIRM_TRADE(2), PLAYER_SHOP_ADD_ITEM(40), BUY_ITEM_PLAYER_SHOP(22), ADD_ITEM(23), BUY_ITEM_STORE(24), BUY_ITEM_HIREDMERCHANT(26), REMOVE_ITEM(30), MAINTANCE_OFF(31), // This is misspelled...
		MAINTANCE_ORGANISE(32), CLOSE_MERCHANT(33), // + 2
		TAKE_MESOS(35), ADMIN_STORE_NAMECHANGE(37), VIEW_MERCHANT_VISITOR(38), VIEW_MERCHANT_BLACKLIST(39), MERCHANT_BLACKLIST_ADD(40), MERCHANT_BLACKLIST_REMOVE(41),

		REQUEST_TIE(51), ANSWER_TIE(52), GIVE_UP(53), REQUEST_REDO(55), ANSWER_REDO(56), EXIT_AFTER_GAME(57), CANCEL_EXIT(58), READY(59), UN_READY(60), EXPEL(61), START(62), SKIP(64), MOVE_OMOK(65), SELECT_CARD(68);
		public int action;
			...
			if (chr.getTrade() != null && chr.getTrade().getPartner() != null && !chr.getTrade().inTrade()) {
				...
				if (ob instanceof IMaplePlayerShop && chr.getPlayerShop() == null) {
					...
					if (ob instanceof HiredMerchant) {
						...
						/*
						 * if (merchant.isOwner(chr) && merchant.isOpen() && merchant.isAvailable()) { merchant.setOpen(false); merchant.removeAllVisitors((byte) 16, (byte) 0); chr.setPlayerShop(ips); c.getSession().write(PlayerShopPacket.getHiredMerch(chr, merchant, false)); } else {
						 */
