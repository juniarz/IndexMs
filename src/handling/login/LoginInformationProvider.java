...
public class LoginInformationProvider {
	...
	public enum JobType {
		UltimateAdventurer(-1, "Ultimate", 0, 130000000), Resistance(0, "Resistance", 3000, 931000000), Adventurer(1, "", 0, 10000), Cygnus(2, "Premium", 1000, 130030000), // 913040000
		Aran(3, "Orient", 2000, 914000000), Evan(4, "Evan", 2001, 900090000), Mercedes(5, "", 2002, 910150000), Demon(6, "", 3001, 931050310), Phantom(7, "", 2003, 915000000), // 2003
		DualBlade(8, "", 0, 103050900), Mihile(9, "", 5000, 913070000), Jett(10, "", 0, 552000010), Cannoneer(11, "", 0, 3000000);
	...
	public static boolean isExtendedSpJob(int jobId) {
		return jobId >= 5000 && jobId <= 5112 || jobId >= 3100 && jobId <= 3512 || jobId / 100 == 22 || jobId / 100 == 23 || jobId == 2002 || jobId == 2001 || jobId == 3000 || jobId == 3001 || jobId == 508 || jobId == 2003 || jobId / 100 == 24 || jobId / 10 == 57;
	}
