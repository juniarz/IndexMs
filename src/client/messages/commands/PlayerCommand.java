...
public class PlayerCommand {
	...
	public abstract static class OpenNPCCommand extends CommandExecute {
		...
		9270035, 9010018, 9000000, 9000030, 9010000, 9000085, 9000018, 9201094 };
	...
	public static class Help extends CommandExecute {
		...
		public int execute(MapleClient c, String[] splitted) {
			...
			/*
			 * if (!GameConstants.GMS) { c.getPlayer().dropMessage(5, "@pokedex < Universal Information >"); c.getPlayer().dropMessage(5, "@pokemon < Universal Monsters Information >"); c.getPlayer().dropMessage(5, "@challenge < playername, or accept/decline or block/unblock >"); }
			 */
