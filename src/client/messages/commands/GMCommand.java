...
public class GMCommand {
	...
	/*
	 * public static class giftnx extends CommandExecute { public int execute(MapleClient c, String[] splitted) { ChannelServer cserv = c.getChannelServer(); cserv.getPlayerStorage().getCharacterByName(splitted[1]).modifyCSPoints(1, Integer.parseInt(splitted[2])); c.getPlayer().dropMessage(6, "The NX has been sent."); return 1; } }
	 */
