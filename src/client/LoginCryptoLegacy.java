 ...
 * 
 * Legacy purpose as the method done here is insecure by hashing multiple times and overly complicated. Will go away when/if official oms has no more users with legacy passhashes.
 * 
 * @author Nol888
 * @version 0.1
 */
