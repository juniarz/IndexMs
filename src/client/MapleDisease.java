...
public enum MapleDisease implements Serializable, Buffstat {
	...
	STUN(0x20000, 1, 123), POISON(0x40000, 1, 125), SEAL(0x80000, 1, 120), DARKNESS(0x100000, 1, 121), WEAKEN(0x40000000, 1, 122), CURSE(0x80000000, 1, 124), SLOW(0x1, 2, 126), MORPH(0x2, 2, 172), SEDUCE(0x80, 2, 128), ZOMBIFY(0x4000, 2, 133), REVERSE_DIRECTION(0x80000, 2, 132), POTION(0x800, 3, 134), SHADOW(0x1000, 3, 135), // receiving damage/moving
	BLIND(0x2000, 3, 136), FREEZE(0x80000, 3, 137), DISABLE_POTENTIAL(0x4000000, 4, 138), TORNADO(0x40000000, 4, 173), FLAG(0x2, 6, 799); // PVP - Capture the Flag
	// 127 = 1 snow?
	// 129 = turn?
